"""
This custom TDT file reader is adapted from the TDTbin2py code from the official
TDT python package. Everything is the same, except the `read_block` function is
modified to a `find_start_and_end_times` function. It finds the start and end 
times of a recording, which is important if the data block was not closed cleanly.
"""
...
def find_start_and_end_times(block_path, *, bitwise='', channel=0, combine=None, headers=0,
